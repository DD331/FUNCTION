...
public class LineEquationTest {
    ...
    public void decideFunctionTest(){
        ...
        assertEquals("Тестирование 2.1 не пройдено![1/2]", 17, fun.decideFunction(2),0.000001);
        assertEquals("Тестирование 2.1 не пройдено![2/2]", 22, fun.decideFunction(3),0.000001);
    }
